---
title: "Benchmark Assignment 2: Thinking Like a Historian"
layout: page
---
...
In consultation with the professor, choose a topic and a primary source relevant to the Inquisition and write an analysis of the document. (For example, if you are interested in conversos, moriscos, protestants, sexual heresies, alumbradas, mystics, etc., we'll find primary sources from Chuchiak or Homza or in the original languages if you speak/read Spanish or Portuguese.) Primary sources are available Canvas in the folder Files. 

Who is writing? What part of inquisitorial procedure is being presented? What kind of allegations are under consideration? What other information or type of information is incidentally included in the source? What words, phrases, references do you not know or understand in the source? Circle or highlight them. Read the content, but also beyond the content of the source. Once you've done so, imagine the potential use of such a source in writing a larger essay or book on the conquest. How might the authors we've looked at thus far utilize the source? Then, write an essay describing the source, its context, and its content. Speculate on what more is needed, more sources, more information, etc. to make sense of the source or to confirm it. Begin your essay with an argument-- an argument for why the source matters. But also, articulate what questions and limitations it forces you to confront in your own knowledge. **Do not include any additional resources or references except those assigned in class. If you use outside resources and cit them, you'll get a zero. If you use them and don't cite them, you'll be referred for plagiarism.**  
